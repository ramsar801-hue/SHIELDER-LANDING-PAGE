...
const features = [
  ...
  },
  {
    ...
    desc: (
      <div className="flex flex-col gap-2">
        <span className="font-bold text-lg text-accent break-words whitespace-normal leading-tight">"Yesterday: $5.2K sales. 32 orders. 1 low stock alert."</span>
        <ul className="flex flex-col gap-1 mt-1">
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>WhatsApp at 8 AM. No login.</span></li>
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Wardrobing. Weight traps. Serial match.</span></li>
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Zero paperwork. OAuth only.</span></li>
        </ul>
      </div>
    ),
    icon: <Zap className="text-accent" size={24} />,
  },
  {
    ...
    desc: (
      <div className="flex flex-col gap-2">
        <span className="font-bold text-lg text-accent break-words whitespace-normal leading-tight">"$2.1K fake returns blocked this month."</span>
        <ul className="flex flex-col gap-1 mt-1">
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Wardrobing. Weight traps. Serial match.</span></li>
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Zero paperwork. Policy enforcement.</span></li>
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>API read-only.</span></li>
        </ul>
      </div>
    ),
    icon: <ShieldCheck className="text-accent" size={24} />,
  },
  {
    ...
    desc: (
      <div className="flex flex-col gap-2">
        <span className="font-bold text-lg text-accent break-words whitespace-normal leading-tight">"$2.5K stockout loss prevented."</span>
        <ul className="flex flex-col gap-1 mt-1">
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Auto-transfer stock. Keep Buy Box.</span></li>
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Zero paperwork. API read-only.</span></li>
          <li className="flex items-start gap-2"><span className="text-accent">✓</span><span>Works across US, UK, CA, AU.</span></li>
        </ul>
      </div>
    ),
    icon: <Globe className="text-accent" size={24} />,
